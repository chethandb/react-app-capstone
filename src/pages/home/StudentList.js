              ...
              <div>
                {(() => {
                  if (student.creditscomplete >= 18) {
                    return <h3> You are eligible for CPT </h3>;
                  } else if (student.lastsem === 'Yes') {
                    return (
                      <h3> You are eligible for OPT, Please apply here</h3>
                    );
                  } else if (student.optflag === 'Yes') {
                    return <h3> You have applied for OPT</h3>;
                  } else if (student.optstartdate === today) {
                    // what condition to check
                    return (
                      <h3>
                        You must upload your EAD documents in SEVP portal within
                        next 10 days as your OPT start date:
                    ...
                    return (
                      <h3>
                        {' '}
                        Your OPT will expire in few days,Pls raise STEM
                        request.OPT approved on:{student.optstartdate}
                      </h3>
                    );
                  } else {
                    return <h3>hello</h3>;
